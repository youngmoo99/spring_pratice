...
public class LearnSpringAopApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		logger.info("BusinessService1Value returned is {}",businessService1.calculaterMax());
		logger.info("BusinessService2Value returned is {}",businessService2.calculaterMin());
