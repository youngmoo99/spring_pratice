...
insert into post(id,description,user_id) values(20003, 'I want to Get AWS', 10001);

insert into post(id,description,user_id) values(20004, 'I want to learn DB', 10001);